...
def init_session_state():
    ...
    st.session_state.msg_forms = False
...
def tela_clientes():
    ...
    with tab2:
        ...
        with st.form("form_cliente",clear_on_submit=st.session_state.msg_forms):
            ...
            if submit:
                ...
                if not cpf_cnpj:
                    st.error("❌ cpf/cnpj e obrigatorio")
                    st.session_state.msg_forms = False
                else:
                    session = db_manager.get_session()
                    ...
                    st.session_state.msg_forms = True
                    st.rerun()
                    st.success(st.session_state.msg_sucesso_cliente)
