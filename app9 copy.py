...
def tela_otimizador():
    ...
    with st.form("form_peca_otimizador", clear_on_submit=True):
        ...
        chapa_selecionada = st.selectbox(
            ...
            options=list(opcoes_chapas.keys()),
            key="select_chapa"
        )
        tipo_chapa_id = opcoes_chapas[chapa_selecionada]
        
        # Seleção de tipo de fita (sempre habilitada)
        ...
        if fitas_disponiveis:
            ...
            fita_selecionada = st.selectbox(
                ...
                options=list(opcoes_fitas.keys()),
                key="select_fita"
            )
            
            tipo_fita_id = opcoes_fitas[fita_selecionada]
            
            print('xxx'+str(tipo_fita_id))
            
            # Só mostra bordas se selecionou uma fita
        ...
        if submit_peca:
            if not nome_peca:
                ...
                peca_data = {
                    ...
                    'tipo_fita_id': tipo_fita_id if usar_fita else None,
